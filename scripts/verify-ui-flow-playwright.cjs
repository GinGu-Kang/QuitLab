...
async function main() {
  ...
  await page.waitForURL((url) => url.toString().includes('/diagnose/step-2'), { timeout: 15000 });
  ...
  await page.waitForURL((url) => url.toString().includes('/diagnose/step-3'), { timeout: 15000 });
