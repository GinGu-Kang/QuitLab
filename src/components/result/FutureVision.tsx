...
export function FutureVision({ name, topResult }: { name: string; topResult: MatchResult }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-lg border border-quiz-border bg-gradient-to-br from-[rgba(13,148,136,0.18)] via-[rgba(20,184,166,0.1)] to-[rgba(245,158,11,0.1)] p-6">
        <p className="text-sm font-semibold text-quiz-text-secondary">— {year}년 —</p>
        <div className="mt-5 flex items-center gap-4">
          <div className="flex h-[72px] w-[72px] items-center justify-center rounded-full bg-gradient-to-br from-quiz-teal to-quiz-teal-light text-2xl font-bold">
            👤
          </div>
          <div>
        ...
        <blockquote className="mt-6 rounded-md bg-[rgba(15,23,42,0.55)] p-5 text-sm leading-8 text-quiz-text-secondary">
