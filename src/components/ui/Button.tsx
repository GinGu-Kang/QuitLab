...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  ...
  return (
    <button
      ref={ref}
      className={cn(
        'inline-flex min-h-11 items-center justify-center rounded-[14px] px-6 py-3.5 text-[15px] font-bold',
        'cursor-pointer border border-transparent',
        'disabled:cursor-not-allowed disabled:opacity-50',
        variant === 'primary' && 'bg-gradient-to-br from-quiz-teal to-quiz-purple text-white shadow-teal',
